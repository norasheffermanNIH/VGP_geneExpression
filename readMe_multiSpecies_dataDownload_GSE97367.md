...
7) Align FASTQ files to make RNA BAMs and run StringTie to get TPMs
...
First, check if the GTF has empty transcript_id lines: head /data/Wilson_Lab/data/VGP_geneExpression/ReferenceGenomes/mus_musculus/ncbi_dataset/data/GCF_000001635.27/genomic.gtf, head /data/Wilson_Lab/data/VGP_geneExpression/ReferenceGenomes/monodelphis_domestica/ncbi_dataset/data/GCF_027887165.1/genomic.gtf, head /data/Wilson_Lab/data/VGP_geneExpression/ReferenceGenomes/ornithorhynchus_anatinus/ncbi_dataset/data/GCF_004115215.2/genomic.gtf, head /data/Wilson_Lab/data/VGP_geneExpression/ReferenceGenomes/xenopus_tropicalis/ncbi_dataset/data/GCF_000004195.4/genomic.gtf
If so, run: grep -v 'transcript_id ""' /data/Wilson_Lab/data/VGP_geneExpression/ReferenceGenomes/mus_musculus/ncbi_dataset/data/GCF_000001635.27/genomic.gtf > /data/Wilson_Lab/data/VGP_geneExpression/ReferenceGenomes/mus_musculus/ncbi_dataset/data/GCF_000001635.27/genomic_cleaned.gtf
...
Run each script sequentially. Do not run the next one until all of the previous jobs are finished
